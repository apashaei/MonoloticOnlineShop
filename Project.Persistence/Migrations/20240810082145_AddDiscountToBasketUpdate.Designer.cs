...
namespace Project.Persistence.Migrations
{
    ...
    [Migration("20240810082145_AddDiscountToBasketUpdate")]
    partial class AddDiscountToBasketUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Project.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 339, DateTimeKind.Local).AddTicks(4969));
            ...
            modelBuilder.Entity("Project.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 339, DateTimeKind.Local).AddTicks(6397));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 339, DateTimeKind.Local).AddTicks(7975));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogFeatures", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 339, DateTimeKind.Local).AddTicks(8975));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogImages", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 339, DateTimeKind.Local).AddTicks(9841));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 340, DateTimeKind.Local).AddTicks(959));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 340, DateTimeKind.Local).AddTicks(2732));
            ...
            modelBuilder.Entity("Project.Domain.Discount.Discount1", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 340, DateTimeKind.Local).AddTicks(4535));
            ...
            modelBuilder.Entity("Project.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 340, DateTimeKind.Local).AddTicks(6226));
            ...
            modelBuilder.Entity("Project.Domain.Orders.OrderItems", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 340, DateTimeKind.Local).AddTicks(7738));
            ...
            modelBuilder.Entity("Project.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 340, DateTimeKind.Local).AddTicks(8679));
            ...
            modelBuilder.Entity("Project.Domain.User.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 10, 10, 21, 45, 341, DateTimeKind.Local).AddTicks(139));
