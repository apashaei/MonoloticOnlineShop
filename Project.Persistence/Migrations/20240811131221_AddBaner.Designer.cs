...
namespace Project.Persistence.Migrations
{
    ...
    [Migration("20240811131221_AddBaner")]
    partial class AddBaner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Project.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(4189));
            ...
            modelBuilder.Entity("Project.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(5337));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(6239));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogFeatures", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(6839));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogImages", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(7459));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(8348));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 575, DateTimeKind.Local).AddTicks(9877));
            ...
            modelBuilder.Entity("Project.Domain.Discount.Discount1", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 576, DateTimeKind.Local).AddTicks(886));
            ...
            modelBuilder.Entity("Project.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 576, DateTimeKind.Local).AddTicks(2403));
            ...
            modelBuilder.Entity("Project.Domain.Orders.OrderItems", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 576, DateTimeKind.Local).AddTicks(3765));
            ...
            modelBuilder.Entity("Project.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 576, DateTimeKind.Local).AddTicks(4527));
            ...
            modelBuilder.Entity("Project.Domain.User.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 11, 15, 12, 21, 576, DateTimeKind.Local).AddTicks(5204));
