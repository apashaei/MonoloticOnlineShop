...
namespace Project.Persistence.Migrations
{
    ...
    [Migration("20240808102124_AddUserAddress")]
            ...
            modelBuilder.Entity("Project.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 710, DateTimeKind.Local).AddTicks(6512));
            ...
            modelBuilder.Entity("Project.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 710, DateTimeKind.Local).AddTicks(7617));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 710, DateTimeKind.Local).AddTicks(8593));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogFeatures", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 710, DateTimeKind.Local).AddTicks(9322));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogImages", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 711, DateTimeKind.Local).AddTicks(71));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 711, DateTimeKind.Local).AddTicks(977));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 711, DateTimeKind.Local).AddTicks(2276));
            ...
            modelBuilder.Entity("Project.Domain.User.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 12, 21, 24, 711, DateTimeKind.Local).AddTicks(3164));
