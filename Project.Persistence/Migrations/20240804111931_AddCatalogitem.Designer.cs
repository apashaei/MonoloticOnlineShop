...
namespace Project.Persistence.Migrations
{
    ...
    [Migration("20240804111931_AddCatalogitem")]
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 19, 31, 220, DateTimeKind.Local).AddTicks(2309));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogFeatures", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 19, 31, 220, DateTimeKind.Local).AddTicks(9143));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogImages", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 19, 31, 221, DateTimeKind.Local).AddTicks(3817));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 19, 31, 221, DateTimeKind.Local).AddTicks(8336));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 4, 13, 19, 31, 222, DateTimeKind.Local).AddTicks(1367));
