...
namespace Project.Persistence.Migrations
{
    ...
    [Migration("20240809125820_AddDiscount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatalogItemDiscounts", b =>
                {
                    ...
                    b.ToTable("CatalogItemDiscounts");
                });
            ...
            modelBuilder.Entity("Project.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 582, DateTimeKind.Local).AddTicks(4566));
            ...
            modelBuilder.Entity("Project.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 582, DateTimeKind.Local).AddTicks(5550));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 582, DateTimeKind.Local).AddTicks(6460));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogFeatures", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 582, DateTimeKind.Local).AddTicks(7166));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogImages", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 582, DateTimeKind.Local).AddTicks(7891));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 582, DateTimeKind.Local).AddTicks(8968));
            ...
            modelBuilder.Entity("Project.Domain.Catalog.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 583, DateTimeKind.Local).AddTicks(988));
            ...
            modelBuilder.Entity("Project.Domain.Discount.Discounts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 583, DateTimeKind.Local).AddTicks(2033));
            ...
            modelBuilder.Entity("Project.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 583, DateTimeKind.Local).AddTicks(3192));
            ...
            modelBuilder.Entity("Project.Domain.Orders.OrderItems", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 583, DateTimeKind.Local).AddTicks(4514));
            ...
            modelBuilder.Entity("Project.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 583, DateTimeKind.Local).AddTicks(5334));
            ...
            modelBuilder.Entity("Project.Domain.User.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 14, 58, 20, 583, DateTimeKind.Local).AddTicks(6216));
            ...
            modelBuilder.Entity("CatalogItemDiscounts", b =>
                {
                    ...
                    b.HasOne("Project.Domain.Discount.Discounts", null)
                        .WithMany()
